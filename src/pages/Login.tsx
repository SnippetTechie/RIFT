...
const Login = () => {
  return (
    <div className="flex min-h-screen bg-white">
        ...
        <div className="max-w-md w-full mx-auto space-y-8">
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between text-xs sm:text-sm">
              ...
              <Link to="/forgot-password" title="Forgot Password?" className="font-semibold text-primary hover:underline">
                Forgot Password?
              </Link>
            </div>
      ...
      {/* Right Column: Art */}
      <div className="hidden lg:block lg:w-1/2 relative bg-primary flex items-center justify-center p-12">
        <img
          src={sideArt}
          alt="Side Art"
          className="absolute inset-0 w-full h-full object-cover grayscale brightness-0 invert"
        />
      </div>
    </div>
  );
